...
public abstract class AbstractEmulatorMojo extends AbstractAndroidMojo
{
    ...
    /**
     * Target values for property names in {@link #BOOT_INDICATOR_PROP_NAMES}
     */
     ...
     * to reach the target value in {@link #BOOT_INDICATOR_PROP_TARGET_VALUES}.
     * One cannot be picky about what is used as a 'booted' indicator,
     * since there are just too many different system implementations and versions out there.
     */
    private static final boolean[] BOOT_INDICATOR_PROP_REQUIRED = { false, false, true };
                ...
                try
                {
                    ...
                    for ( int indicatorProp = 0; indicatorProp < BOOT_INDICATOR_PROP_NAMES.length; ++indicatorProp )
                    {
                        ...
                        requiredTargetStatesReached &=
                                BOOT_INDICATOR_PROP_REQUIRED[indicatorProp] ? targetStateReached : true;
